...
export function FarmList({ farms, selectedFarm, onSelectFarm, isLoading }: FarmListProps) {
          ...
          <div className="flex items-start justify-between">
            <div className="min-w-0 flex-1">
              <div className="flex items-center space-x-3">
                <h3 className="text-sm font-medium text-gray-900 truncate">{farm.name}</h3>
            ...
            <div className="ml-4 flex-shrink-0 opacity-0 group-hover:opacity-100 transition-opacity">
              <button
                ...
                className="
                  mr-2 text-gray-400 hover:text-indigo-600
